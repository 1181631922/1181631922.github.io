...
// Edge <= 0="" 6="" 10="" 12="" -="" 13+,="" firefox="" <="18" 45+,="" ie="" 11,="" safari="" 5.1="" 9+,="" ios="" 9.1="" throw="" exceptions="" when="" non-strict="" code="" (e.g.,="" asp.net="" 4.5)="" accesses="" strict="" mode="" arguments.callee.caller="" (trac-13335).="" but="" as="" of="" jquery="" 3.0="" (2016),="" should="" be="" common="" enough="" that="" all="" such="" attempts="" are="" guarded="" in="" a="" try="" block.="" "use="" strict";="" var="" arr="[];" document="window.document;" getproto="Object.getPrototypeOf;" slice="arr.slice;" concat="arr.concat;" push="arr.push;" indexof="arr.indexOf;" class2type="{};" tostring="class2type.toString;" hasown="class2type.hasOwnProperty;" fntostring="hasOwn.toString;" objectfunctionstring="fnToString.call(" object="" );="" support="{};" function="" domeval(="" code,="" doc="" )="" {="" ||="" document;="" script="doc.createElement(" "script"="" script.text="code;" doc.head.appendchild(="" ).parentnode.removechild(="" }="" version="3.0.0" ,="" define="" local="" copy="" selector,="" context="" the="" is="" actually="" just="" init="" constructor="" 'enhanced'="" need="" if="" called="" (just="" allow="" error="" to="" thrown="" not="" included)="" return="" new="" jquery.fn.init(="" },="" support:="" android="" only="" make="" sure="" we="" trim="" bom="" and="" nbsp="" rtrim="/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g," matches="" dashed="" string="" for="" camelizing="" rmsprefix="/^-ms-/," rdashalpha="/-([a-z])/g," used="" by="" jquery.camelcase="" callback="" replace()="" fcamelcase="function(" all,="" letter="" letter.touppercase();="" };="" jquery.fn="jQuery.prototype" =="" current="" being="" jquery:="" version,="" constructor:="" jquery,="" default length="" length:="" 0,="" toarray:="" function()="" slice.call(="" this="" get="" nth="" element="" matched="" set="" or="" whole="" clean="" array="" get:="" function(="" num="" !="null" ?="" one="" from="" (="" this[="" +="" this.length="" ]="" :="" elements="" take="" an="" it="" onto="" stack="" (returning="" set)="" pushstack:="" elems="" build="" ret="jQuery.merge(" this.constructor(),="" add="" old="" (as="" reference)="" ret.prevobject="this;" newly-formed="" ret;="" execute="" every="" set.="" each:="" jquery.each(="" this,="" map:="" this.pushstack(="" jquery.map(="" elem,="" i="" callback.call(="" i,="" elem="" slice:="" slice.apply(="" arguments="" first:="" this.eq(="" last:="" -1="" eq:="" len="this.length," j="+i">= 0 && j < len ? [ this[ j ] ] : [] );
	},
...
jQuery.extend( {
	...
	type: function( obj ) {
		...
		// Support: Android <=2.3 0="" 1="" 2="" 12="" 13="" only="" (functionish="" regexp)="" return="" typeof="" obj="==" "object"="" ||="" "function"="" ?="" class2type[="" tostring.call(="" )="" ]="" :="" obj;="" },="" evaluates="" a="" script="" in="" global="" context="" globaleval:="" function(="" code="" {="" domeval(="" );="" convert="" dashed="" to="" camelcase;="" used="" by="" the="" css="" and="" data="" modules="" support:="" ie="" <="9" -="" 11,="" edge="" microsoft="" forgot="" hump="" their="" vendor="" prefix="" (#9572)="" camelcase:="" string="" string.replace(="" rmsprefix,="" "ms-"="" ).replace(="" rdashalpha,="" fcamelcase="" nodename:="" elem,="" name="" elem.nodename="" &&="" elem.nodename.tolowercase()="==" name.tolowercase();="" each:="" obj,="" callback="" var="" length,="" i="0;" if="" (="" isarraylike(="" length="obj.length;" for="" ;="" length;="" i++="" callback.call(="" obj[="" ],="" i,="" false="" break;="" }="" else="" android="" trim:="" text="" null="" ""="" +="" rtrim,="" results="" is="" internal="" usage="" makearray:="" arr,="" ret="results" [];="" arr="" !="null" object(="" jquery.merge(="" ret,="" "string"="" [="" push.call(="" ret;="" inarray:="" -1="" indexof.call(="" only,="" phantomjs="" push.apply(_,="" arraylike)="" throws="" on="" ancient="" webkit="" merge:="" first,="" second="" len="+second.length," j="0," len;="" j++="" first[="" ];="" first.length="i;" first;="" grep:="" elems,="" callback,="" invert="" callbackinverse,="" matches="[]," callbackexpect="!invert;" go="" through="" array,="" saving="" items="" that="" pass="" validator="" function="" callbackinverse="!callback(" elems[="" matches.push(="" matches;="" arg="" map:="" value,="" translating="" each="" of="" new="" values="" elems="" value="callback(" ret.push(="" every="" key="" object,="" flatten="" any="" nested="" arrays="" concat.apply(="" [],="" guid="" counter="" objects="" guid:="" 1,="" bind="" context,="" optionally="" partially="" applying="" arguments.="" proxy:="" fn,="" tmp,="" args,="" proxy;="" tmp="fn[" fn="tmp;" quick="" check="" determine="" target="" callable,="" spec="" this="" typeerror,="" but="" we="" will="" just="" undefined.="" !jquery.isfunction(="" undefined;="" simulated="" args="slice.call(" arguments,="" proxy="function()" fn.apply(="" this,="" args.concat(="" slice.call(="" arguments="" };="" set="" unique="" handler="" same="" original="" handler,="" so="" it="" can="" be="" removed="" proxy.guid="fn.guid" =="" fn.guid="" jquery.guid++;="" now:="" date.now,="" jquery.support="" not="" core="" other="" projects="" attach="" properties="" needs="" exist.="" support="" jshint="" would="" error="" due="" symbol="" being="" defined="" es5.="" defining="" .jshintrc="" create="" danger="" using="" unguarded="" another="" place,="" seems="" safer="" disable="" these="" three="" lines.="" *="" ignore:="" start="" jquery.fn[="" symbol.iterator="" end="" populate="" class2type="" map="" jquery.each(="" "boolean="" number="" array="" date="" regexp="" object="" symbol".split(="" "="" ),="" "[object="" "]"="" real="" ios="" 8.2="" (not="" reproducible="" simulator)="" `in`="" prevent="" jit="" (gh-2145)="" hasown="" isn't="" here="" negatives="" regarding="" nodelist="" "length"="" obj.length,="" type="jQuery.type(" jquery.iswindow(="" false;="" "array"="" "number"=""> 0 && ( length - 1 ) in obj;
}
var Sizzle =
/*!
		...
		option: {
			get: function( elem ) {
				...
				return val != null ?
					...
					// Support: IE <=10 0="" 1="" 11="" -="" only="" option.text="" throws="" exceptions="" (#14686,="" #14858)="" strip="" and="" collapse="" whitespace="" https:="" html.spec.whatwg.org="" #strip-and-collapse-whitespace="" jquery.trim(="" jquery.text(="" elem="" )="" ).replace(="" rspaces,="" "="" );="" }="" },="" select:="" {="" get:="" function(="" var="" value,="" option,="" options="elem.options," index="elem.selectedIndex," one="elem.type" =="=" "select-one",="" values="one" ?="" null="" :="" [],="" max="one" +="" options.length,="" i="index" <="" 0;="" loop through="" all="" the="" selected for="" (="" ;="" max;="" i++="" option="options[" ];="" support:="" ie="" ie8-9="" doesn't="" update="" after="" form="" reset="" (#2551)="" if="" option.selected="" ||="" &&="" don't="" return="" that="" are="" disabled or="" in="" a="" optgroup="" !option.disabled="" !option.parentnode.disabled="" !jquery.nodename(="" option.parentnode,="" "optgroup"="" get="" specific="" value="" ).val();="" we="" need="" an="" array="" selects="" value;="" multi-selects="" values.push(="" values;="" set:="" elem,="" optionset,="" ),="" while="" i--="" jquery.valhooks.option.get(=""> -1
					) {
						optionSet = true;
					}
				}
...
jQuery.fn.extend( {
	offset: function( options ) {
		...
		// Support: IE </div></=9></=44></=10></=9></=4.3></=9></=35></=4.0></=10></=2.3></=42></=4.1></=9></tbody></=9></=43></=9></=></=></"></)></tag></\></537.32></9,></9></8></9></option></29,></8></option></4.0></24></=2.3></=>